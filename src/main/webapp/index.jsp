...
<body>
	...
	<div id="carouselExampleIndicators" class="carousel slide">
		...
		<div class="carousel-inner">
			...
			<div class="carousel-item">
				<img src="img/doctor4.jpg" class="d-block w-100" alt="..."
					height="500px">
			</div>
		</div>
	...
	<div class="container p-3">
		...
		<div class="row">
					...
					<div class="col-md-6">
						<div class="card point-card">
							<div class="card-body">
								...
								<p>One of the greatest hospital through out the region.
									Almost 100% patient satisfaction</p>
							</div>
						</div>
					</div>
					<div class="col-md-6">
			...
			<div class="col-md-4">
				<img alt="doctor" src="img/doctor.png" />
			</div>
		</div>
	</div>
			...
			<div class="col-md-3">
				<div class="card point-card">
					<div class="card-body text-center">
						...
						<p class="fw-bold fs-5">Dr. Junaid</p>
			...
			<div class="col-md-3">
				<div class="card point-card">
					<div class="card-body text-center">
						...
						<p class="fw-bold fs-5">Dr. Aftab</p>
			...
			<div class="col-md-3">
				<div class="card point-card">
					<div class="card-body text-center">
						...
						<p class="fw-bold fs-5">Dr. Samina</p>
						<p class="fs-7">(Chief Doctor)</p>
					</div>
				</div>
			</div>
			<div class="col-md-3">
				<div class="card point-card">
					<div class="card-body text-center">
						...
						<p class="fw-bold fs-5">Dr. Sharqa</p>
						<p class="fs-7">(Chief Doctor)</p>
					</div>
				</div>
			</div>
